...
for i in range(runs):
    if i % 1000000 == 0:
        ...
        ratio = Decimal((len(grid)-MAX_HEIGHT))/Decimal(i+1)
        
        print(f' Ratio = {ratio}')
        print(f'Ratio Difference = {ratio - last_ratio}')
        if ratio - last_ratio < 0.000000000001:
            print("POSSIBLE HEIGHT")
        last_ratio = ratio
...
# Still very different so can't really make conclusions. Try a 20 million for fun.
# 1.535483143395104548607670201
# 1535483143395 # Answer too low
# 1000000000000
...
# runs rationum
        #1535483143395
# 00.250 1535324546626
# 02.500 1535472965247
# 25.000 1535483143395
# 40.000 1535483539787



# Try running until the ratio approaches the asymptote? haha
# try after 40m
# Try 100m print ratio and ratio diff each time.